...
from .jainamxts_mapping import JainamXTSExchangeMapper, JainamXTSCapabilityRegistry
...
class JainamXTSWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def _connect_with_retry(self) -> None:
        ...
        while self.running and self.reconnect_attempts < self.max_reconnect_attempts:
            try:
                self.logger.info(f"Connecting to JainamXTS WebSocket (attempt {self.reconnect_attempts + 1})")
    ...
    def cleanup_zmq(self) -> None:
        ...
        try:
            ...
            self.logger.info("JainamXTS WebSocket cleanup completed successfully")
        except Exception as e:
