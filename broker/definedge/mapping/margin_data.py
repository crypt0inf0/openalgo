...
from database.token_db import get_symbol_info, get_br_symbol
from broker.definedge.mapping.transform_data import map_product_type, map_exchange
    ...
    for position in positions:
        try:
            ...
            if not tradingsymbol:
                logger.warning(f"Broker symbol not found for: {position['symbol']} on {position['exchange']}")
                continue
